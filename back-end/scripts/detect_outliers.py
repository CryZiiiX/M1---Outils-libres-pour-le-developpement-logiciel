#!/usr/bin/env python3
# =============================================================================
# Fichier : back-end/scripts/detect_outliers.py
# Rôle    : Détecter les valeurs aberrantes du dataset (méthodes IQR et Z-score).
...
# =============================================================================
"""Détecter les valeurs aberrantes du dataset (méthodes IQR et Z-score)."""
...
def analyze_outliers():
    ...
    for col in numerical_cols:
        ...
        if n_outliers_iqr > 0:
            ...
            outlier_indices_iqr = outliers_iqr_mask[outliers_iqr_mask].index.tolist()[
                :10
            ]
        else:
        ...
        if n_outliers_zscore > 0:
            ...
            outlier_indices_zscore = outliers_zscore_mask[
                outliers_zscore_mask
            ].index.tolist()[:10]
        else:
        ...
        for result in results:
            ...
            if result["ZScore_Count"] > 0:
                ...
                if len(result["ZScore_Indices"]) > 0:
                    f.write(
                        f"  Exemples d'indices (max 10): {result['ZScore_Indices']}\n"
                    )
            f.write("\n")
            f.write("=" * 80 + "\n\n")
